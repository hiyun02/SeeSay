		...
		<div class="d-flex flex-column align-items-center justify-content-center" style="padding-top: 5%">
			<div class="card card-bg p-4" style="box-shadow: 1px 1px 3px 3px">
				<div class="login-title">
					<h2 class="text-center text-primary" style="padding-bottom: 10%">비밀번호 변경</h2>
				</div>
				<form>

					<div class="input-group custom">
						<label for="inputPassword1" class="form-label">변경할 비밀번호</label>
						<input class="form-control rounded-pill border-white input-box" id="inputPassword1" type="password" name="password" placeholder="변경할 비밀번호를 입력해주세요" required="required"
							   onkeyup="password_Check()" />
						<div class="invalid-feedback">변경할 비밀번호를 입력해주세요</div>
					</div>
					<div class="input-group custom">
						<label for="inputPassword2" class="form-label">비밀번호</label>
						<input class="form-control rounded-pill border-white input-box" id="inputPassword2" type="password" placeholder="변경할 비밀번호를 입력해주세요" required="required"
							   onkeyup="password_Check()"/>
						<div class="invalid-feedback">변경할 비밀번호를 입력해주세요</div>
					</div>
					<p id="check"></p>
					...
					<div class="row">
						<div class="col-sm-12">
							<div class="input-group mb-0">
                                ...
                                -->
								<a class="btn btn-primary btn-lg btn-block" href="/user/findPwdProc">비밀번호 변경</a>
							</div>
