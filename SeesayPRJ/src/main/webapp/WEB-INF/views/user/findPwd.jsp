		...
		<div class="d-flex flex-column align-items-center justify-content-center" style="padding-top: 5%">
			<div class="card card-bg p-4" style="box-shadow: 1px 1px 3px 3px">
				<div class="login-title">
					<h2 class="text-center text-primary" style="padding-bottom: 10%">비밀번호 찾기</h2>
				</div>
				<form>
					<div class="input-group custom">
						<label for="inputID" class="form-label">아이디</label>
						<input class="form-control rounded-pill border-white input-box" id="inputID" name="userId" type="text" placeholder="아이디를 입력해주세요" />
						<div class="invalid-feedback">아이디를 입력해주세요</div>
					</div>
					<div class="input-group custom">
						<label for="inputEmail" class="form-label">이메일</label>
						<input class="form-control rounded-pill border-white input-box" id="inputEmail" name="email" type="email" placeholder="이메일을 입력해주세요" />
					...
					<div class="row">
						<div class="col-sm-12">
							<div class="input-group mb-0">
								<input class="btn btn-primary btn-lg btn-block" type="submit" value="임시비밀번호 전송">
							</div>
						</div>
					</div>
				</form>
