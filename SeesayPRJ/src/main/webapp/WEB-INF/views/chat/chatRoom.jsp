			...
			<div class="row gy-3">
				...
				<div class="col-lg-4 col-md-5 aos-init aos-animate" data-aos="fade-up" data-aos-delay="200">
					<div id="box01" class="service-box blue">
						...
						<p><br><br></p>
						<a href="/chat/facechat" class="read-more"><h3>화상채팅</h3></a>
					</div>
				</div>

				<div class="col-lg-4 col-md-5 aos-init aos-animate" data-aos="fade-up" data-aos-delay="200">
					<div id="box02" class="service-box blue">
						<div><img src="/assets/img/chat.png"></div>
						<p><br><br></p>
						<a href="/chat/chat" class="read-more"><h3>1 : 1 채팅</h3></a>
					</div>
				</div>
