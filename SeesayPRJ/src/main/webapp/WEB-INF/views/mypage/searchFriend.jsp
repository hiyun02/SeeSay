        ...
        function searchFriend() {
            $.ajax({
                ...
                success: function (json) {
                    ...
                    $("#searchResult").append("<div class='nearby-user'>"
                        +"<div class='row'>"
                        ...
                        +"<button onclick='location.href='/mypage/addFriendList?followee="+userId+";' class='btn btn-primary pull-right'>친구 추가</button>"
                        +"</div>"
                        +"</div>"
                        +"</div>");
...
<div class="container" style="margin-top: 5%;">
    <div class="row">
        <div class="col-md-12">
            <footer id="footer" class="footer"><div class="footer-newsletter">
                <div class="container">
                    <div class="row justify-content-center">
                        <div class="col-lg-12 text-center"><h4>친구 찾기</h4></div>
                        <div class="col-lg-6">
                            <form action="#" method="post" onsubmit="return false;"> <input id="email" type="email" name="email"><input type="submit" onclick="searchFriend();" value="검색">
                            </form></div></div></div></div></footer>              <!-- end profile -->


            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <div id="searchResult" class="people-nearby">
            ...
            <div class="profile-content">
                ...
                <div class="tab-content p-0">
                    ...
                    <div class="tab-pane fade in active show" id="profile-friends">
                        <h4 class="m-t-0 m-b-20">친구 리스트 ( <%=rLength%> )</h4>
                        <!-- begin row -->
                        <div class="row row-space-2">

                            <%for(int i=0;i<rLength;i++) {
                                UserDTO uDTO = rList.get(i);
                            %>
                            <!-- begin col-6 -->
                                ...
                                <div class="p-10 bg-white">
                                    <div class="media media-xs overflow-visible">
                                        <a class="media-left" href="javascript:;">
                                            <img src="https://bootdey.com/img/Content/avatar/avatar<%=i+1%>.png" alt="" class="media-object img-circle">
                                        </a>
                                        <div class="media-body valign-middle">
                                            <b class="text-inverse"><%=uDTO.getUserName()%></b>
                                        </div>
                                        <div class="media-body valign-middle text-right overflow-visible">
                                            <button onclick="location.href='/mypage/deleteFriend?friendId=<%=uDTO.getUserId()%>'" class="btn btn-primary pull-right">삭제</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="circle" style="float: right"><img src="/assets/img/ringbell.png"></div>
                        <!-- end row -->
                    </div>
